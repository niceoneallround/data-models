...
CANON_DATA = {
  alice: {
    ...
    AetnaMemberIdNeededForAcceptto: 'alice_mem_acceptto'
  },
  ...
  bob: {
    ...
    AetnaMemberIdNeededForAcceptto: 'bob_mem_acceptto'
  },
  ...
  rich: {
    ...
    AetnaMemberIdNeededForAcceptto: 'rich_mem_acceptto'
  },
  ...
  roger: {
    ...
    AetnaMemberIdNeededForAcceptto: 'roger_mem_acceptto'
  }
};
...
utils.createRoger = function createRoger() {
  ...
  if (COMMON_CD[name].additionalName) {
    b[EXPERIAN_P.Middle] = COMMON_CD[name].additionalName;
  }
