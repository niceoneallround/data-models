...
utils.checkSubjectStructure = function checkSubjectStructure(s, props) {
  ...
  s.should.have.property(EXPERIAN_P.ExperianID);
  ...
  address.should.have.property(EXPERIAN_P.Address);
...
utils.createBob = function createBob() {
  ...
  b[EXPERIAN_P.ExperianID] = CANON_DATA.bob.ExperianID;
  b[EXPERIAN_P.SourceID] = CANON_DATA.bob.SourceID;

  // add address
  b[EXPERIAN_P.CurrentAddress] = ExperianPnDataModel.utils.createAddressNode();
  b[EXPERIAN_P.CurrentAddress][EXPERIAN_P.Address] = COMMON_CD.bob.AddressLine1;
...
utils.createAlice = function createAlice() {
  ...
  b[EXPERIAN_P.ExperianID] = CANON_DATA.alice.ExperianID;
  b[EXPERIAN_P.SourceID] = CANON_DATA.alice.SourceID;

  // add address
  b[EXPERIAN_P.CurrentAddress] = ExperianPnDataModel.utils.createAddressNode();
  b[EXPERIAN_P.CurrentAddress][EXPERIAN_P.Address] = COMMON_CD.alice.AddressLine1;
...
utils.createRich = function createRich() {
  ...
  b[EXPERIAN_P.ExperianID] = CANON_DATA.rich.ExperianID;
  b[EXPERIAN_P.SourceID] = CANON_DATA.rich.SourceID;

  // add address
  b[EXPERIAN_P.CurrentAddress] = ExperianPnDataModel.utils.createAddressNode();
  b[EXPERIAN_P.CurrentAddress][EXPERIAN_P.Address] = COMMON_CD.rich.AddressLine1;
