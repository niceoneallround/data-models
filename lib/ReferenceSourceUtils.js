...
//-----------------------
utils.createRSSubjectQueryResult = function createRSSubjectQueryResult(subjectQuery, resultSubject, hostname) {
  'use strict';
  assert(subjectQuery, 'createRSSubjectQueryResult - subjectQuery param is nissing');
  assert(resultSubject, 'createRSSubjectQueryResult - resultSubject param is missing');
  ...
  // seperate ou the query and the subject so can push down the pipe
  result.push(rsq);
