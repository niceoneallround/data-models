...
const PROPERTY = {
  ...
  data:                     URLS.P3 + 'data', // used in public query output
  ...
  postQueryResultURL:       URLS.P2 + 'post_query_result_url', // used in query privacy agent
  ...
  provisionPipeURL:         URLS.P2 + 'provision_pipe_url', // used in privacy agents
  ...
  queryNodes:               URLS.P3 + 'query_nodes',
  queryResultNodes:         URLS.P3 + 'query_result_nodes',
  queryResultGraphProp:     URLS.P3 + 'query_result_graph_prop', // used to create public query result
  queryProjection:          URLS.P + 'query_projection', // v2 hold props to project in query provision - NOT USED
  queryPrivacyAgent:        URLS.P3 + 'query_privacy_agent', // holds the @id of a query privacy agent
  queryRestriction:         URLS.P + 'query_restriction', // node holds query restrictions used across types of queries NOt-USEd
  ...
  queryResultGraphNode:     URLS.P3 + 'query_result_graph_node', // used on query
  ...
  subjectQueryURL:          URLS.P2 + 'subject_query_url', // used in reference source pa
  ...
  sourceData:               URLS.P3 + 'source_data', // used in public uery output
  subjectID:                URLS.P3 + 'subjectID',
  subjectLinkJWT:           URLS.P3 + 'subject_link_JWT', // an array of subject link JWTs
...
const TYPE = {
  ...
  Query:                    URLS.T2 + 'Query', // a query policy
  QueryNode:                URLS.T3 + 'QueryNode',
  QueryResultNode:          URLS.T3 + 'QueryResultNode',
  ...
  SubjectQuery:             URLS.T3 + 'SubjectQuery', // response
  ...
  QueryPrivacyAgent:          URLS.T3 + 'QueryPrivacyAgent',
...
//
// Create a query restriction id of a known format - that will be unique for log files
// *hostname - the hostname of called for example acme.com
// *id - an id to be added to end
//
// The format is https://pn.id.webshield.io/query_restriction/<hostname reversed>#id
//
model.ids.createQueryRestrictionId = function createQueryRestrictionId(hostname, id) {
  var type = 'https://pn.id.webshield.io/query_restriction';
  return helperCreateId(type, hostname, id);
};
...
//
// Create a query privacy agent of a known format - that will be unique for log files
// *hostname - the hostname of called for example acme.com
// *id - an id to be added to end
//
// The format is https://md.pn.id.webshield.io/query_privacy_agent/<hostname reversed>#id
//
model.ids.createQueryPrivacyAgentId = function createQueryPrivacyAgentId(hostname, id) {
  var type = MD_ID_PREFIX + '/query_privacy_agent';
  return helperCreateId(type, hostname, id);
};
