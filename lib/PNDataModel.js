...
PROPERTY = {
  ...
  destinationProvisionBaseUrl: URLS.P2 + 'destination_provision_base_url', // used in the PB to override default behaviour of using the destination hostname as base
