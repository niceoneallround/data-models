...
PROPERTY = {
  ...
  propType:                 URLS.P2 + 'prop_type', // used in a schema to identify a type - a the type URL
...
TYPE = {
  ...
  // privacy node
  CreateProvisionPrivacyStep:   URLS.T + 'CreateProvisionPrivacyStep',
  ProvisionedPrivacyStep:       URLS.T + 'ProvisionedPrivacyStep',
};
...
// *id - an id to be added to end
//
// The format is https://pn.id.webshield.io/privacy_step/<hostname reversed>#id
//
model.ids.createPrivacyStepId = function createPrivacyStepId(hostname, id) {
  var type = 'https://pn.id.webshield.io/privacy_step';
  return helperCreateId(type, hostname, id);
};
...
// *id - an id to be added to end
//
// The format is https://pn.id.webshield.io/privacy_action/<hostname reversed>#id
//
model.ids.createPrivacyActionId = function createPrivacyActionId(hostname, id) {
  var type = 'https://pn.id.webshield.io/privacy_action';
  return helperCreateId(type, hostname, id);
};
