...
// *id - an id to be added to end
//
// The format is https://id.webshield.io/link_subject/<hostname reversed>#id
//
model.ids.createLinkSubjectId = function createLinkSubjectId(hostname, id) {
  var type = 'https://pn.id.webshield.io/link_subject';
  return helperCreateId(type, hostname, id);
};
