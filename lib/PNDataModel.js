...
PROPERTY = {
  ...
  //
  rsProvisionBaseURL:       URLS.P2 + 'rs_provision_base_url',
  rsSubjectQueryBaseURL:    URLS.P2 + 'rs_subject_query_base_url',
  rsCredentials:            URLS.P2 + 'rs_credentials', // needed to access the resource
...
// *id - an id to be added to end
//
// The format is https://md.pn.id.webshield.io/resource/<hostname reversed>#id
//
model.ids.createResourceId = function createResourceId(hostname, id) {
