...
PROPERTY = {
  ...
  contentEncryptKeyMD:      URLS.P2 + 'content_encrypt_key_md', //privacy action
  ...
  rawEncryptKeyMetadataType: URLS.P2 + 'raw_encrypt_key_metadata_type', // v2 part of encrypt key metadata
