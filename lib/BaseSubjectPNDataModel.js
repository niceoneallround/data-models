...
const JSON_SCHEMA = {
  ...
  required: ['@id', '@type', 'https://pn.schema.webshield.io/prop#sourceID']
};
...
const JSONLD_CONTEXT = {
  ...
  Subject:       'https://subject.pn.schema.webshield.io/type#Subject',
...
function createCanonSubject(s, props) {
  ...
  t['@id'] = s.id;
  t['@type'] = TYPE.Subject;
  t[PROPERTY.givenName] = s.givenName;
  t[PROPERTY.familyName] = s.familyName;
