...
const utils = {
  ...
  createAddressNode: function createAddressNode() {
    return { '@type': [TYPE.PostalAddress] };
  }
};
...
canons.createAlice = function createAlice() {
  return createSubject(canons.data.alice);
};

canons.createBob = function createBob() {
  return createSubject(canons.data.bob);
};
