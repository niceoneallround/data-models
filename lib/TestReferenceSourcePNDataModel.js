...
const ID = 'https://pn.id.webshield.io/data_model/io/webshield/test#reference_source';

// Used to prefix types and props that are specific to this schema
const SCHEMA_PREFIX = 'https://testrs.pn.schema.webshield.io';
...

{
  ...
  "definitions": {
   "https://schema.org/PostalAddress": {
    ...
    "https://testrs.pn.schema.webshield.io/prop#transactionID": { "type": "string" },
...
const JSON_SCHEMA = {
  ...
  title: 'https://testrs.pn.schema.webshield.io/type#Subject',
  type: 'object',
  properties: {
    '@id':        { type: 'string' },
    '@type':      { type: 'array' },
...
context.Subject = 'https://testrs.pn.schema.webshield.io/type#Subject';
context.transactionID = 'https://testrs.pn.schema.webshield.io/prop#transactionID';
...
// only add new types
const TYPE = {
  Subject: 'https://testrs.pn.schema.webshield.io/type#Subject',
};

// only add new properties
const PROPERTY = {
  transactionID: 'https://testrs.pn.schema.webshield.io/prop#transactionID',
};
...
canons.data = {
  alice: {
    id:         'https://testrs.webshield.io/memberId/alice_abc',
    givenName:  'alice',
    familyName: 'Smith',
    sourceID:   'https://testrs.webshield.io/memberId/alice_abc',
    taxID:      'alice_abc_ssn',
  ...
  bob: {
    id:         'https://testrs.webshield.io/memberId/bob_abc',
    givenName:  'bob',
    familyName: 'Adrvark',
    sourceID:   'https://testrs.webshield.io/memberId/bob_abc',
    taxID:      'bob_abc_ssn',
