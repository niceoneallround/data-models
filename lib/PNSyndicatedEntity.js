...
class PNSyndicatedEntity {
  ...
  static createJSON(id, props) {
    ...
    assert(props.subjectIds, util.format('PNSyndicatedEntity - create - props.subjectIds param missing:%j', props));

    let subjectIds = props.subjectIds;
    if (!Array.isArray(subjectIds)) {
      subjectIds = [subjectIds]; // for ease of processing
    }
