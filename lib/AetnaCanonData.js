...
CANON_DATA = {
  ...
  // support old format but move across
  aliceAetnaId:       'http://id.webshield.io/xycom/aetna/people/alice',
  aliceAetnaSourceID: 'http://aetna.xycom/people/alice',
  alice: {
    AetnaId:         'http://id.webshield.io/xycom/aetna/people/alice',
    AetnaSourceID:   'http://aetna.xycom/people/alice',
    AetnaMemberIdNeededForAcceptto: 'http://fake.aetna.xycom/acceptto_atena_alice_link_id'
  },

  //
  // support old format but move accross
  //
  bobAetnaId:         'http://id.webshield.io/xycom/aetna/people/bob',
  bobAetnaSourceID:   'http://aetna.xycom/people/bob',

  bob: {
    AetnaId:         'http://id.webshield.io/xycom/aetna/people/bob',
    AetnaSourceID:   'http://aetna.xycom/people/bob',
    AetnaMemberIdNeededForAcceptto: 'http://fake.aetna.xycom/acceptto_atena_bob_link_id'
  },

  rich: {
    AetnaId:         'http://id.webshield.io/xycom/aetna/people/rich',
    AetnaSourceID:   'http://aetna.xycom/people/rich',
    AetnaMemberIdNeededForAcceptto: 'http://fake.aetna.xycom/acceptto_atena_rich_link_id'
  },

  roger: {
    AetnaId:         'http://id.webshield.io/xycom/aetna/people/roger',
    AetnaSourceID:   'http://aetna.xycom/people/roger',
    AetnaMemberIdNeededForAcceptto: 'http://fake.aetna.xycom/acceptto_atena_roger_link_id'
  }
};
...
function checkSubjectStructure(s, props) {
  ...
  if (COMMON_CD[props.name].AetnaMemberIdNeededForAcceptto) {
    s.should.have.property(AETNA_P.AetnaMemberIdNeededForAcceptto);
  }
...
function createBob() {
  ...
  b[AETNA_P.AetnaMemberIdNeededForAcceptto] = CANON_DATA.bob.AetnaMemberIdNeededForAcceptto;
...
function createAlice() {
  ...
  b[AETNA_P.AetnaMemberIdNeededForAcceptto] = CANON_DATA.alice.AetnaMemberIdNeededForAcceptto;
...
function createRich() {
  ...
  b[AETNA_P.AetnaMemberIdNeededForAcceptto] = CANON_DATA.rich.AetnaMemberIdNeededForAcceptto;
...
function createRoger() {
  ...
  b[AETNA_P.AetnaMemberIdNeededForAcceptto] = CANON_DATA[name].AetnaMemberIdNeededForAcceptto;
